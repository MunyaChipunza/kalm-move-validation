...
| KALM Move Form Short Set | White, Brown, Khaki, Dark Purple, Sky Blue, Yellow, Black, Pink, Orange, Dark Red | S, M, L, XL | 3 per live colour | Regenerated from scratch into `form-short-set-v2` from `IMG-20260709-WA0082` to `WA0084`. Each live suit colour has human model front, angle and back views preserving the V-front halter bra, straight-band open back and high-waist fitted shorts. Small buffalo marks were generated into the top and shorts, then only cropped/resized/exported after QA. | Complete for third-product diverse human-model reset |
| KALM Move Open Back Short Romper | Black, Pink, Blue, Army Green, Navy, Apricot | S, M, L, XL | 3 per live colour | Generated from scratch into `open-back-short-romper-v1` from the July 10 stand-collar hollow-back romper screenshots. Each colour has human model front, angle and back views preserving the stand collar, sleeveless one-piece body, hollow open back, short inseam and rear ruched seam. One small buffalo mark is used only at the left lower short hem where visible. | Complete for fourth-product diverse human-model reset |
...
| KALM Move Ease Flare Set | Sage, Black, Taupe, Espresso, Cream | XS, S, M, L, XL | 3 per live colour | Regenerated from scratch into `ease-flare-set-v4` after failed logo/edit QA. Each colour was generated as a new human model render from `IMG-20260709-WA0077` to `WA0078`, with the square-neck tank, thin straps, low X-back and flare pants specified in the prompt. Small buffalo marks were generated into the top and pants, then only cropped/resized/exported after QA. | Complete for second-product diverse human-model reset |
