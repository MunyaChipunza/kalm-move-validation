...
| KALM Move Ease Flare Set | Sage, Black, Taupe, Espresso, Cream | XS, S, M, L, XL | 3 per live colour | Generated diverse model-on-body images matched to `IMG-20260709-WA0077` to `WA0078`; rejected and regenerated taupe back until the X-back strap construction matched; composited approved buffalo mark on upper hip/thigh for front and angle views only | Complete for second-product diverse human-model reset |
