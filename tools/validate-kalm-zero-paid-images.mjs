...
if (!JSON.stringify(bottle).includes("assets/images/products/kalm-move/bottles-v4/studio-bottle/")) fail("Studio Bottle final V4 path is not active.");
...
console.log(JSON.stringify({
  ...
  historicalBottleStage2Assets: bottleStage2.assetCount
}, null, 2));
