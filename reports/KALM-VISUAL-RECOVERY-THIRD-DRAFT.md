# KALM Visual Recovery: Third Draft
...
| --- | --- | --- | --- |
| KALM Move Brands-page lifestyle panel | assets/images/recovered/brands-v1/kalm-move-brand-hero-lifestyle-v1.webp | `6B723801B848` | preview_candidate_pending_munya_visual_approval |
| KALM Outdoor Brands-page lifestyle panel | assets/images/recovered/brands-v1/kalm-outdoor-brand-hero-lifestyle-v1.webp | `9FE5532ABA7B` | preview_candidate_pending_munya_visual_approval |
...
- Men V3: 46/46 found, 0 used. The historical men recovery remains active until Munya product-detail approval.
