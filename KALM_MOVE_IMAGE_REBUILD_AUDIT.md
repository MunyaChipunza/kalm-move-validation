...
| KALM Move Ease Flare Set | Sage, Black, Taupe, Espresso, Cream | XS, S, M, L, XL | Generated diverse human ecommerce model `front.webp`, `angle.webp`, `back.webp` per colour; checked against supplier square-neck tank, X-back strap and flare-leg reference; approved buffalo mark added only to upper hip/thigh on front and angle views |
