...
export default async function payfastRedirect(request) {
  try {
    ...
    return html(`<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="referrer" content="no-referrer"><title>Redirecting to secure payment</title></head><body><main><p>Continue to secure payment.</p></main><form id="payfast" method="post" action="${getPayFastProcessUrl(runtime.mode)}" target="_blank">${inputs}<button type="submit">Continue to secure payment</button></form></body></html>`, 200, {
